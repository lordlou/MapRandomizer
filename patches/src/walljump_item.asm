...
!bank_84_free_space_start = $84F660
!bank_84_free_space_end = $84F760
...
dw $EE64, inst        ; PLM $F660 (wall-jump boots)
dw $EE64, inst_orb    ; PLM $F664 (wall-jump boots, chozo orb)
dw $EE8E, inst_sce    ; PLM $F668 (wall-jump boots, scenery shot block)

;;; Instruction list - PLM $F660 (wall-jump boots)
inst:
...
;;; Instruction list - PLM $F664 (wall-jump boots, chozo orb)
inst_orb:
    dw $8764, $9100                        ; Load item PLM GFX
    db $01, $01, $01, $01, $01, $01, $01, $01
    dw $887C, .end                         ; Go to end if the room argument item is set
...
;;; Instruction list - PLM $F668 (wall-jump boots, scenery shot block)
inst_sce:
    dw $8764, $9100                        ; Load item PLM GFX
    db $01, $01, $01, $01, $01, $01, $01, $01
.start:
