...
pub struct RandomizationState {
    ...
    #[pyo3(get)]
    pub global_state: GlobalState,
    pub done: bool, // Have all key items been placed?
    #[pyo3(get)]
...
impl Randomizer {
    ...
    fn finish(&self, state: &mut RandomizationState) {
        ...
        for item_id in 0..(self.game_data.item_isv.keys.len() - 2) {
        ...
        loop {
            ...
            if let Some(select_res) = select_result {
                ...
                for &item in placed_uncollected_bireachable_items.iter().chain(
                    ...
                    new_state.global_state.collect(item, self.game_data.as_ref());
                }
...
impl Randomizer {
    ...
    fn get_spoiler_start_state(&self, global_state: &GlobalState) -> SpoilerStartState {
        ...
        for i in 0..(self.game_data.item_isv.keys.len() - 2) {
