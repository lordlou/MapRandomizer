...
pub fn compute_cost(local: LocalState, global: &GlobalState) -> [f32; NUM_COST_METRICS] {
    let eps = 1e-15;
...
pub struct TraverseResult {
    #[pyo3(get)]
    pub local_states: Vec<[Option<LocalState>; NUM_COST_METRICS]>,
    #[pyo3(get)]
    pub cost: Vec<[f32; NUM_COST_METRICS]>,
    #[pyo3(get)]
    pub step_trails: Vec<StepTrail>,
    #[pyo3(get)]
    pub start_trail_ids: Vec<[Option<StepTrailId>; NUM_COST_METRICS]>,
}
